...
const Dashboard = () => {
   ...
   useEffect(() => {
    ...
    <div class="col main pt-5 mt-3">
        ...
        <p class="lead d-none d-sm-block">Enrolled Courses</p>
        ...
        <div class="row mb-3">
            <div class="col-xl-3 col-sm-6 py-2" style={{height:200}}>
                <div class="card bg-success text-white h-100">
                    <div class="card-body bg-success" style={{backgroundColor:"#57b960"}}>
                        <div class="rotate">
                            <i class="fa-solid fa-book fa-4x"></i>
                        </div>
                        <h6 class="text-uppercase">Course 1</h6>
                        <h1 class="display-4"  style={styleObj}>Due Exams</h1>
            ...
            <div class="col-xl-3 col-sm-6 py-2"  style={{height:200}}>
                <div class="card text-white bg-danger h-100">
                    <div class="card-body bg-danger">
                        ...
                        <h6 class="text-uppercase">Course 2</h6>
                        <h1 class="display-4" style={styleObj}>Due Exams</h1>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 py-2"  style={{height:200}}>
                <div class="card text-white bg-info h-100">
                    <div class="card-body bg-info">
                        ...
                        <h6 class="text-uppercase">Course 3</h6>
                        <h1 class="display-4" style={styleObj}>Due Exams</h1>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 py-2"  style={{height:200}}>
                <div class="card text-white bg-warning h-100">
                    <div class="card-body">
                        <div class="rotate">
                            <i class="fa-solid fa-file-circle-check fa-4x"></i>
                        </div>
                        <h6 class="text-uppercase">Course 4</h6>
                        <h1 class="display-4" style={styleObj}>Due Exams</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 col-md-6 col-sm-12">
              <h5 class="mt-3 mb-3 text-secondary">
               Your Exams
                ...
                <div class="table-responsive" style={{overflowX:"scroll",maxWidth:"100%"}}>
...
const styleObj={fontSize:30,position: "absolute", bottom:0};
const displayExams={width:window.innerWidth-100};
